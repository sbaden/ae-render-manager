...
// function verifyPanelReady(profileUI){
    ...
    if(profileUI.data.csv){
        switch(profileUI.data.file){
        	...
        	case null:
        	case undefined:
        		var messageStr_script = 'You have opted to use a CSV but no CSV has been selected';
	...
	if(profileUI.batch.custom){
		switch(profileUI.batch.pathCustom){
        	...
        	case null:
        	case undefined:
        		var messageStr_script = 'Custom batch path has been chosen but no path has been selected';
    ...
    if(profileUI.render.custom){
		switch(profileUI.render.pathCustom){
        	...
        	case null:
        	case undefined:
        		var messageStr_script = 'Custom render path has been chosen but no path has been selected';
